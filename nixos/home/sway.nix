...
{
  home.file.".local/share/wallpapers/venti_dark.jpg".source = "${flakeRoot}/assets/venti_dark.jpg";
  ...
  wayland.windowManager.sway = {
    ...
    config = {
      ...
      startup = [
        {
          command = "sh -c 'pkill -x waybar; while pgrep waybar > /dev/null; do sleep 0.1; done; waybar'";
          always = true;
        }
      ];
      ...
      keybindings =
        let
          ...
          workspaceShiftBindings = builtins.listToAttrs (
            map (n: {
        ...
        // {
          ...
          "${mod}+Shift+k" = "move up";
          # this logic sucks ASS dawg
          # "${mod}+Shift+h" = "mark swap, focus left, swap container with mark swap";
          # "${mod}+Shift+l" = "mark swap, focus right, swap container with mark swap";
          ...
          "${mod}+Shift+c" = "exec grim -g \"$$(slurp)\" - | zbarimg -q --raw - | wl-copy";
